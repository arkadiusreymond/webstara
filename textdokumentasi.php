	 ...
	 <div class="container">
      <div class="row">
        ...
        <div class="col-md-9">
            ...
            <h1 style="color:#0C97E2; text-shadow: 2px 2px 2px rgba(0,0,0,0.2); ">STARA Text Documentation</h1>
          
		   <br/>
			 <div class="row">
            <div class="col-md-12">
              <p style="text-align:justify;text-justify:inter-word;">Saat ini sudah banyak ditemui pemberian dokumentasi online bersama-sama dengan 
...
dalam bentuk sistem bantuan berbasis hypertext. Stara Text Documentation menyediakan layanan pembuatan text documentation untuk sistem aplikasi. Dengan dibantu oleh tenaga berpengalaman, layanan ini dapat membantu anda
untuk mendokumentasikan informasi dari sistem aplikasi anda, sehingga memudahkan user yang ingin mendaoatkan informasi yang tepat dan up-to-date mengenai sistem aplikasi anda.
 <br/><br/>
 <img src="images/textdokumen.jpg"  alt="sop" /><br/>
</p>
	</div>  
          </div><!--/row-->
		  ...
		  <div class="row">
		    <div class="col-md-3" style="margin-top:-1.72cm;">
          ...
          <div class="footerTopSection2">
            <ul class="nav nav-list" style="margin-top:-1cm;">
			  ...
			  <p> Untuk dapat menggunakan jasa Layanan kami dalam pembuatan Text Documentation, silahkan menghubungi kami di :<br>
			  Phone : (021)<br>
			  Email :<br>
			  </p>
