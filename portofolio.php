...
<body>
   ...
   <div id="top" class="topHeaderSection">		
    ...
    <div class="col-md-9">
  		<h1 style="color:#0C97E2; text-shadow: 2px 2px 2px rgba(0,0,0,0.2); ">Portofolio</h1>
		<br/>
		<div class="row">
      	<div class="col-md-12">
          ...
          <div class="footerTopSection2">
            <ul class="nav nav-list" style="margin-top:-1cm;">
             <li class="pricelist" style="text-transform:uppercase;"><strong>Price List</strong></li><br/>
			  <p> Untuk dapat menggunakan jasa layanan Web Design & Application, silahkan menghubungi kami di :<br>
			  Phone : (021)<br>
			  Email :<br>
			  </p>
            </ul>
